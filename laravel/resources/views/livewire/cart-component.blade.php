					...
					<ul class="products-cart">
						...
						<li class="pr-cart-item">
							...
							<div class="product-name">
								<a class="link-to-product" href="{{route('product.details',['slug'=>$cartitem->model->slug])}}">{{$cartitem->model->name}}</a>
							</div>
							<div class="price-field produtc-price"><p class="price">${{$cartitem->model->regular_price}}</p></div>
							<div class="quantity">
								<div class="quantity-input">
									<input style="color: black" type="text" name="product-quatity" value="{{$cartitem->qty}}" data-max="120" pattern="[0-9]*" >									
									<a class="btn btn-increase" href="#" wire:click.prevent="increaseQuantity('{{$cartitem->rowId}}')"></a>
						...
						<li>
							...
							<a href="/shop"><button class="p-1 bg-yellow-600">Shop Now</button></a>	
						</li>
						@endif
